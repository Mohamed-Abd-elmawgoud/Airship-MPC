// Generated by gencpp from file nmpc_blimp_formation_planner/OptimizationResult.msg
// DO NOT EDIT!


#ifndef NMPC_BLIMP_FORMATION_PLANNER_MESSAGE_OPTIMIZATIONRESULT_H
#define NMPC_BLIMP_FORMATION_PLANNER_MESSAGE_OPTIMIZATIONRESULT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> const> ConstPtr;

}; // struct OptimizationResult_

typedef ::nmpc_blimp_formation_planner::OptimizationResult_<std::allocator<void> > OptimizationResult;

typedef boost::shared_ptr< ::nmpc_blimp_formation_planner::OptimizationResult > OptimizationResultPtr;
typedef boost::shared_ptr< ::nmpc_blimp_formation_planner::OptimizationResult const> OptimizationResultConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator1> & lhs, const ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaf1bd1e7f40ea424ULL;
  static const uint64_t static_value2 = 0x386b21d5312bdc7fULL;
};

template<class ContainerAllocator>
struct DataType< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nmpc_blimp_formation_planner::OptimizationResult_<ContainerAllocator>& v)
  {
    if (false || !indent.empty())
      s << std::endl;
    s << indent << "solution: ";
    if (v.solution.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.solution.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.solution[i]);
    }
    if (v.solution.empty() || true)
      s << "]";
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "lagrange_multipliers: ";
    if (v.lagrange_multipliers.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.lagrange_multipliers.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.lagrange_multipliers[i]);
    }
    if (v.lagrange_multipliers.empty() || true)
      s << "]";
    if (true || !indent.empty())
...
#endif // NMPC_BLIMP_FORMATION_PLANNER_MESSAGE_OPTIMIZATIONRESULT_H

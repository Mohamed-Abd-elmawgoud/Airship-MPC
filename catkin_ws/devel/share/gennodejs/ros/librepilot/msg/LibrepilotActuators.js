...
class LibrepilotActuators {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LibrepilotActuators(null);
  ...
  static datatype() {
    ...
    return 'librepilot/LibrepilotActuators';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LibrepilotActuators(null);
...
module.exports = LibrepilotActuators;

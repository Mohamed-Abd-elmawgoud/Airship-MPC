...
(cl:defclass <NeuralNetworkDetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector neural_network_detector-msg:NeuralNetworkDetection)
   :initform (cl:make-array 0 :element-type 'neural_network_detector-msg:NeuralNetworkDetection :initial-element (cl:make-instance 'neural_network_detector-msg:NeuralNetworkDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <NeuralNetworkDetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NeuralNetworkDetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neural_network_detector-msg:<NeuralNetworkDetectionArray> is deprecated: use neural_network_detector-msg:NeuralNetworkDetectionArray instead.")))
...
(cl:defmethod detections-val ((m <NeuralNetworkDetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:detections-val is deprecated.  Use neural_network_detector-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <NeuralNetworkDetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'neural_network_detector-msg:NeuralNetworkDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NeuralNetworkDetectionArray>)))
  ...
  "neural_network_detector/NeuralNetworkDetectionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NeuralNetworkDetectionArray)))
  "Returns string type for a message object of type 'NeuralNetworkDetectionArray"
  "neural_network_detector/NeuralNetworkDetectionArray")

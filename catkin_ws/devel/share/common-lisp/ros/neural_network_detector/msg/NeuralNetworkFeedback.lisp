...
(cl:defmethod cl:initialize-instance :after ((m <NeuralNetworkFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NeuralNetworkFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neural_network_detector-msg:<NeuralNetworkFeedback> is deprecated: use neural_network_detector-msg:NeuralNetworkFeedback instead.")))
...
(cl:defmethod xcenter-val ((m <NeuralNetworkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:xcenter-val is deprecated.  Use neural_network_detector-msg:xcenter instead.")
  (xcenter m))

(cl:ensure-generic-function 'debug_included-val :lambda-list '(m))
(cl:defmethod debug_included-val ((m <NeuralNetworkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:debug_included-val is deprecated.  Use neural_network_detector-msg:debug_included instead.")
  (debug_included m))

(cl:ensure-generic-function 'head_raw-val :lambda-list '(m))
(cl:defmethod head_raw-val ((m <NeuralNetworkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:head_raw-val is deprecated.  Use neural_network_detector-msg:head_raw instead.")
  (head_raw m))

(cl:ensure-generic-function 'feet_raw-val :lambda-list '(m))
(cl:defmethod feet_raw-val ((m <NeuralNetworkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:feet_raw-val is deprecated.  Use neural_network_detector-msg:feet_raw instead.")
  (feet_raw m))

(cl:ensure-generic-function 'ycenter-val :lambda-list '(m))
(cl:defmethod ycenter-val ((m <NeuralNetworkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_detector-msg:ycenter-val is deprecated.  Use neural_network_detector-msg:ycenter instead.")
  (ycenter m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NeuralNetworkFeedback>)))
  ...
  "neural_network_detector/NeuralNetworkFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NeuralNetworkFeedback)))
  "Returns string type for a message object of type 'NeuralNetworkFeedback"
  "neural_network_detector/NeuralNetworkFeedback")

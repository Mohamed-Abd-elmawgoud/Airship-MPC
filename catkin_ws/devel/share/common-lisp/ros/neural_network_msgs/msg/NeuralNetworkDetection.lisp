...
(cl:defmethod cl:initialize-instance :after ((m <NeuralNetworkDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NeuralNetworkDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neural_network_msgs-msg:<NeuralNetworkDetection> is deprecated: use neural_network_msgs-msg:NeuralNetworkDetection instead.")))
...
(cl:defmethod object_class-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:object_class-val is deprecated.  Use neural_network_msgs-msg:object_class instead.")
  (object_class m))

(cl:ensure-generic-function 'detection_score-val :lambda-list '(m))
(cl:defmethod detection_score-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:detection_score-val is deprecated.  Use neural_network_msgs-msg:detection_score instead.")
  (detection_score m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:xmin-val is deprecated.  Use neural_network_msgs-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:xmax-val is deprecated.  Use neural_network_msgs-msg:xmax instead.")
  (xmax m))
...
(cl:defmethod variance_xmin-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:variance_xmin-val is deprecated.  Use neural_network_msgs-msg:variance_xmin instead.")
  (variance_xmin m))

(cl:ensure-generic-function 'variance_xmax-val :lambda-list '(m))
(cl:defmethod variance_xmax-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:variance_xmax-val is deprecated.  Use neural_network_msgs-msg:variance_xmax instead.")
  (variance_xmax m))

(cl:ensure-generic-function 'variance_ymin-val :lambda-list '(m))
(cl:defmethod variance_ymin-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:variance_ymin-val is deprecated.  Use neural_network_msgs-msg:variance_ymin instead.")
  (variance_ymin m))

(cl:ensure-generic-function 'variance_ymax-val :lambda-list '(m))
(cl:defmethod variance_ymax-val ((m <NeuralNetworkDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:variance_ymax-val is deprecated.  Use neural_network_msgs-msg:variance_ymax instead.")
  (variance_ymax m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NeuralNetworkDetection>)))
  ...
  "neural_network_msgs/NeuralNetworkDetection")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NeuralNetworkDetection)))
  "Returns string type for a message object of type 'NeuralNetworkDetection"
  "neural_network_msgs/NeuralNetworkDetection")

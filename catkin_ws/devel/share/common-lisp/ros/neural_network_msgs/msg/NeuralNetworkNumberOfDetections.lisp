...
(cl:defmethod cl:initialize-instance :after ((m <NeuralNetworkNumberOfDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NeuralNetworkNumberOfDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neural_network_msgs-msg:<NeuralNetworkNumberOfDetections> is deprecated: use neural_network_msgs-msg:NeuralNetworkNumberOfDetections instead.")))
...
(cl:defmethod data-val ((m <NeuralNetworkNumberOfDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neural_network_msgs-msg:data-val is deprecated.  Use neural_network_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NeuralNetworkNumberOfDetections>)))
  ...
  "neural_network_msgs/NeuralNetworkNumberOfDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NeuralNetworkNumberOfDetections)))
  "Returns string type for a message object of type 'NeuralNetworkNumberOfDetections"
  "neural_network_msgs/NeuralNetworkNumberOfDetections")

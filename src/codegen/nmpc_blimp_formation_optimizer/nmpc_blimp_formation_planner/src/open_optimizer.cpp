 ...
 */
#include "ros/ros.h"
#include "nmpc_blimp_formation_planner/OptimizationResult.h"
#include "nmpc_blimp_formation_planner/OptimizationParameters.h"
...
private:
     ...
     */
    nmpc_blimp_formation_planner::OptimizationParameters params;
    /**
     ...
     */
    nmpc_blimp_formation_planner::OptimizationResult results;
    /**
...
public:
    ...
    void mpcReceiveRequestCallback(
        const nmpc_blimp_formation_planner::OptimizationParameters::ConstPtr& msg)
    {
        params = *msg;
    }
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher mpc_pub
        = private_nh.advertise<nmpc_blimp_formation_planner::OptimizationResult>(
            result_topic,
